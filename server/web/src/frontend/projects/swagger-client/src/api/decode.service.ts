...
export class DecodeService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public startDecode(project_uuid: string, training_version: number, audio_reference_object: AudioReferenceObject, observe?: 'body', reportProgress?: boolean): Observable<DecodeTaskReference>;
    public startDecode(project_uuid: string, training_version: number, audio_reference_object: AudioReferenceObject, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<DecodeTaskReference>>;
    public startDecode(project_uuid: string, training_version: number, audio_reference_object: AudioReferenceObject, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<DecodeTaskReference>>;
    public startDecode(project_uuid: string, training_version: number, audio_reference_object: AudioReferenceObject, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (project_uuid === null || project_uuid === undefined) {
        ...
        if (audio_reference_object === null || audio_reference_object === undefined) {
            throw new Error('Required parameter audio_reference_object was null or undefined when calling startDecode.');
        }
