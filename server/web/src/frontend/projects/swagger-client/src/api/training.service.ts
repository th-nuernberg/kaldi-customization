...
export class TrainingService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public prepareTrainingByVersion(project_uuid: string, training_version: number, callback?: Callback, observe?: 'body', reportProgress?: boolean): Observable<Training>;
    public prepareTrainingByVersion(project_uuid: string, training_version: number, callback?: Callback, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Training>>;
    public prepareTrainingByVersion(project_uuid: string, training_version: number, callback?: Callback, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Training>>;
    public prepareTrainingByVersion(project_uuid: string, training_version: number, callback?: Callback, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (project_uuid === null || project_uuid === undefined) {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public startTrainingByVersion(project_uuid: string, training_version: number, callback?: Callback, observe?: 'body', reportProgress?: boolean): Observable<Training>;
    public startTrainingByVersion(project_uuid: string, training_version: number, callback?: Callback, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Training>>;
    public startTrainingByVersion(project_uuid: string, training_version: number, callback?: Callback, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Training>>;
    public startTrainingByVersion(project_uuid: string, training_version: number, callback?: Callback, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (project_uuid === null || project_uuid === undefined) {
        ...
        return this.httpClient.put<Training>(`${this.configuration.basePath}/project/${encodeURIComponent(String(project_uuid))}/training/${encodeURIComponent(String(training_version))}/enqueue`,
            callback,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
