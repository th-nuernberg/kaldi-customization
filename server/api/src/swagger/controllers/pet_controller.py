...
def update_pet_with_form(pet_id, name=None, status=None):  # noqa: E501
    ...
    """
    if connexion.request.is_json:
        name = .from_dict(connexion.request.get_json())  # noqa: E501
    if connexion.request.is_json:
...
def upload_file(pet_id, additional_metadata=None, file=None):  # noqa: E501
    ...
    :type additional_metadata: dict | bytes
    :param file: 
    :type file: strstr
    ...
    """
    if connexion.request.is_json:
        additional_metadata = .from_dict(connexion.request.get_json())  # noqa: E501
    return 'do some magic!'
