...
class ProjectApi(object):
    ...
    def create_project(self, project_creation, **kwargs):  # noqa: E501
        """Create a new project  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_project(project_creation, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param ProjectCreation project_creation: Project object that needs to be created (required)
        ...
        return self.create_project_with_http_info(project_creation, **kwargs)  # noqa: E501

    def create_project_with_http_info(self, project_creation, **kwargs):  # noqa: E501
        """Create a new project  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_project_with_http_info(project_creation, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['project_creation']  # noqa: E501
        ...
        # verify the required parameter 'project_creation' is set
        if ('project_creation' not in local_var_params or
                local_var_params['project_creation'] is None):
            raise ApiValueError("Missing the required parameter `project_creation` when calling `create_project`")  # noqa: E501
        ...
        body_params = None
        if 'project_creation' in local_var_params:
            body_params = local_var_params['project_creation']
        # HTTP header `Accept`
