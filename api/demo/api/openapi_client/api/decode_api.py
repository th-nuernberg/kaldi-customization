...
class DecodeApi(object):
    ...
    def assign_audio_to_training_with_http_info(self, project_uuid, training_version, audio_reference_object, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(Decoding, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            response_type='Decoding',  # noqa: E501
    ...
    def delete_assigned_audio_from_training(self, project_uuid, training_version, decode_uuid, **kwargs):  # noqa: E501
        """Remove an audio resource from training  # noqa: E501

        Removes the assigned audio resource from the training  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_assigned_audio_from_training(project_uuid, training_version, decode_uuid, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str project_uuid: UUID of the project (required)
        :param int training_version: Training version of the project (required)
        :param str decode_uuid: UUID of the resource (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.delete_assigned_audio_from_training_with_http_info(project_uuid, training_version, decode_uuid, **kwargs)  # noqa: E501

    def delete_assigned_audio_from_training_with_http_info(self, project_uuid, training_version, decode_uuid, **kwargs):  # noqa: E501
        """Remove an audio resource from training  # noqa: E501

        Removes the assigned audio resource from the training  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_assigned_audio_from_training_with_http_info(project_uuid, training_version, decode_uuid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_assigned_audio_from_training" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'project_uuid' is set
        if ('project_uuid' not in local_var_params or
                local_var_params['project_uuid'] is None):
            raise ApiValueError("Missing the required parameter `project_uuid` when calling `delete_assigned_audio_from_training`")  # noqa: E501
        # verify the required parameter 'training_version' is set
        if ('training_version' not in local_var_params or
                local_var_params['training_version'] is None):
            raise ApiValueError("Missing the required parameter `training_version` when calling `delete_assigned_audio_from_training`")  # noqa: E501
        ...
        if ('decode_uuid' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `decode_uuid` when calling `delete_assigned_audio_from_training`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/project/{project_uuid}/training/{training_version}/decode/{decode_uuid}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_decodings_with_http_info(self, project_uuid, training_version, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(list[Decoding], status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[Decoding]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def start_decode_with_http_info(self, project_uuid, training_version, decode_uuid, **kwargs):  # noqa: E501
        ...
        all_params = ['project_uuid', 'training_version', 'decode_uuid', 'callback']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def start_decode_all(self, project_uuid, training_version, **kwargs):  # noqa: E501
        """Decode audio to text  # noqa: E501

        Decode audio data to text using the trained project and the given audio  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.start_decode_all(project_uuid, training_version, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.start_decode_all_with_http_info(project_uuid, training_version, **kwargs)  # noqa: E501

    def start_decode_all_with_http_info(self, project_uuid, training_version, **kwargs):  # noqa: E501
        """Decode audio to text  # noqa: E501

        Decode audio data to text using the trained project and the given audio  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.start_decode_all_with_http_info(project_uuid, training_version, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method start_decode_all" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'project_uuid' is set
        if ('project_uuid' not in local_var_params or
                local_var_params['project_uuid'] is None):
            raise ApiValueError("Missing the required parameter `project_uuid` when calling `start_decode_all`")  # noqa: E501
        # verify the required parameter 'training_version' is set
        if ('training_version' not in local_var_params or
                local_var_params['training_version'] is None):
            raise ApiValueError("Missing the required parameter `training_version` when calling `start_decode_all`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/project/{project_uuid}/training/{training_version}/decode/enqueue_all', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
